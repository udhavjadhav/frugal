...
export function Footer() {
  return (
    <footer className="w-full mt-2 mb-3">
      {/* <div className="mx-2 flex max-w-14xl flex-col items-start space-x-8 md:flex-row">
      ...
      <hr className="my-4" />
      <div className="mx-2 max-w-14xl items-center justify-between px-4 md:flex lg:px-0">
        ...
        <div className="mt-4 md:mt-0">
          <p className="text-sm font-medium text-gray-500">© 2023 Frugal Innovations. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
